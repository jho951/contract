...
| Service | Repo | SoT Branch | Contract Sync File | Status |
|---|---|---|---|---|
| Gateway | https://github.com/jho951/Api-gateway-server | main | `CONTRACT_SYNC.md` | adopted |
...
- `Editor-server` 저장소는 현재 접근 가능한 URL이 확인되지 않아 매트릭스에서 제외했습니다.
