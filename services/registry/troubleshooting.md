...
##### 확인
- `conventions/shared/audit.md`
- 구현 레포 운영 문서 또는 local `troubleshooting.md`
...
##### 확인
- `services/registry/deployment-topology.md`
...
- `services/server/editor/troubleshooting.md`
- `services/server/editor/troubleshooting.md`
- `services/client/editor/README.md`
...
- [Contract Lock Template](../../infra/templates/contract-lock-template.yml)
- [Agent Task Template](../../infra/templates/agent-task-template.md)
...
- `services/artifacts/openapi/v1/public.yaml`
...
- `services/server/auth/troubleshooting.md`
- `services/client/editor/README.md`
- `services/client/explain/README.md`
- `services/server/gateway/troubleshooting.md`
...
#### 확인
- `services/registry/module-ecosystem.md`
- `services/server/gateway/troubleshooting.md`
- `services/server/auth/troubleshooting.md`
- `services/server/user/troubleshooting.md`
- `services/server/authz/troubleshooting.md`
...
#### 확인
- `services/registry/contract-oss.md`
- `services/registry/module-ecosystem.md`
- `services/server/auth/troubleshooting.md`
- `services/server/user/troubleshooting.md`
- `services/server/authz/troubleshooting.md`
...
#### 확인
- `conventions/shared/single-ec2-edge-routing.md`
- `infra/templates/single-ec2/nginx.single-ec2.conf.example`
- `infra/templates/single-ec2/env/monitoring-service.env.prod.example`
...
#### 확인
- `infra/scripts/deploy-bundle/deploy-stack.sh`
- `infra/templates/single-ec2/deploy-bundle/docker-compose.backend.yml`
- `service-gateway/.github/workflows/cd.yml`
...
- `service-contract/infra/templates/single-ec2/deploy-bundle/*` 원본 내용
...
- 예시는 `user-service`처럼 예전 경로인 `artifacts/openapi/user-service.v1.yaml`를 `consumes`에 남겨둔 경우다.
