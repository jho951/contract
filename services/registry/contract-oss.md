...
기준은 local `BE/platform/*`, `BE/services/*` 구현과 이 `contract` 레포의 service/infra 문서다.
...
- AI agent 수행 절차: [../../infra/templates/agent-task-template.md](../../infra/templates/agent-task-template.md)
