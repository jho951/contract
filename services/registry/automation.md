...
## 현재 적용 대상
2026-04-20 기준 guardrail은 다음 8개 서비스/모듈 레포에 반영한다.

| Target | Contract Path | Lock | Workflow |
| --- | --- | --- | --- |
| `gateway` | `services/server/gateway` | `contract.lock.yml` | `.github/workflows/contract-check.yml` |
| `auth` | `services/server/auth` | `contract.lock.yml` | `.github/workflows/contract-check.yml` |
| `authz` | `services/server/authz` | `contract.lock.yml` | `.github/workflows/contract-check.yml` |
| `user` | `services/server/user` | `contract.lock.yml` | `.github/workflows/contract-check.yml` |
| `editor` | `services/server/editor` | `contract.lock.yml` | `.github/workflows/contract-check.yml` |
| `redis` | `services/server/redis` | `contract.lock.yml` | `.github/workflows/contract-check.yml` |
| `monitoring` | `services/server/monitoring` | `contract.lock.yml` | `.github/workflows/contract-check.yml` |
| `audit-log` | `conventions/shared/audit.md` | `contract.lock.yml` | `.github/workflows/contract-check.yml` |
...
service:
  ...
  consumes:
    ...
    - conventions/shared/errors.md
    - services/server/auth/**
