...
- 프론트엔드 레포 예시: [README Contract Source Section](../../infra/templates/readme-contract-source-frontend.md)
...
- 예시 템플릿: [Contract Lock Template](../../infra/templates/contract-lock-template.yml)
