...
- Shared VPC root: `conventions/shared/terraform/shared-platform-network/`
...
- 비용 제약이 해제되면 `conventions/shared/terraform/shared-platform-network/`를 apply해서 shared VPC와 private hosted zone을 만든다.
