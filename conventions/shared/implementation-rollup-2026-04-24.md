...
- [conventions/pipeline/ci-cd-procedure.md](../pipeline/ci-cd-procedure.md): image stage, ECR naming, immutable tag, build/run 분리 규칙 추가
- [conventions/shared/single-ec2-deployment.md](./single-ec2-deployment.md): single EC2 운영에서도 image-only 배포 규칙 반영
- [conventions/shared/single-ec2-edge-routing.md](./single-ec2-edge-routing.md): backend 7개와 frontend 2개를 함께 노출하는 최종 포트/도메인/Nginx 기준 추가
- [infra/templates/single-ec2/README.md](../../infra/templates/single-ec2/README.md): ECR image URI 주입 기준 반영
- [infra/templates/single-ec2/nginx.single-ec2.conf.example](../../infra/templates/single-ec2/nginx.single-ec2.conf.example): EC2 reverse proxy 예시 추가
- [infra/templates/single-ec2/env/](../../infra/templates/single-ec2/env/): 서비스별 `*_IMAGE` 변수 추가
- [infra/templates/contract-lock-template.yml](../../infra/templates/contract-lock-template.yml): 기본 image registry를 ECR로 변경
- [../../infra/github/workflow-templates/contract-check.yml](../../infra/github/workflow-templates/contract-check.yml): ECR login 예시로 변경
- [services/repositories.yml](../../services/repositories.yml): 기본 CD profile의 image registry를 ECR로 정리
