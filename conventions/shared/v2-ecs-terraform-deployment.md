...
- 공통 CI/CD 기준: [../pipeline/ci-cd-procedure.md](../pipeline/ci-cd-procedure.md)
...
- 자세한 기준은 [monitoring.md](monitoring.md), 각 서비스의 local `troubleshooting.md`, 구현 레포 운영 문서를 따른다.
...
CI/CD는 [../pipeline/ci-cd-procedure.md](../pipeline/ci-cd-procedure.md)를 따르되, v2 deploy 단계는 아래 기준으로 바꾼다.
